...
public class BagOfTricksTooltipComponent implements ClientTooltipComponent {
	...
	public BagOfTricksTooltipComponent(List<ItemStack> bundleContents, ItemStack stack) {
	...
	private int selectedIndex() {
		return BagOfTricksItem.getInternalIndex(this.stack);
	}
